...
Обязательным условием использования плагина является наличие активной ссылки на сайт разработчика Netlanc (http://pluginator.ru/),
которая уже прописана в плагине. Отключить ссылку можно за донейт от 5уе, реквизиты для донейта в пункте ВАШЕ УЧАСТИЕ.
...
СПОНСОРЫ
Спонсор v0.1 - http://pluginator.ru/